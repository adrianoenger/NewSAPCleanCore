...
| 05 | Durable Pipeline | Pause/resume/recover/retry stage processing |
| 06 | Object Understanding | AI produces validated functional/technical object understanding |
| 07 | Business Rule Discovery | Browse rules with confidence and source evidence |
| 08 | Application Discovery | Browse functional applications composed of related objects/rules |
| 09 | SAP Knowledge MCP | Findings/applications show contextual SAP/ABAP guidance |
| 10 | Clean Core Intelligence | Risk, business importance and recommendation with evidence |
